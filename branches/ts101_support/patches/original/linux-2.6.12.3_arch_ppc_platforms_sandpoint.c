--- linux-2.6.12.3/arch/ppc/platforms/sandpoint.c	2005-07-15 17:18:57.000000000 -0400
+++ linux-2.6.12.3-qnap/arch/ppc/platforms/sandpoint.c	2007-02-17 14:10:23.000000000 -0500
@@ -94,13 +94,15 @@
 #include <asm/vga.h>
...
+	printk(KERN_INFO "Port by QNAP Systems, Inc. (sales@qnap.com.tw)\n");
