--- linux-2.6.12.3/drivers/block/rd_TS-100.c	1969-12-31 19:00:00.000000000 -0500
+++ linux-2.6.12.3-qnap/drivers/block/rd_TS-100.c	2007-02-17 14:10:17.000000000 -0500
@@ -0,0 +1,519 @@
+/*
...
+//Modified by Ken Chen
+		//set_capacity(disk, rd_size * 2);
+		if (i == 0) set_capacity(disk, 4608 * 2);
